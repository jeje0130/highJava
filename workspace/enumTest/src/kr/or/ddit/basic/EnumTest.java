 ...
 * 
 * 			// 열거형의 생성자륾 만든다.
 * 			// 열거형의 생성자는 '열거형 상수'에 '값들'을 셋팅하는 역할을
 * 				수행한다. (열거형 생성자는 묵시적으로 private이다)
 * 
 * 			//'변수명'의 개수는 '값들'의 개수와 같고,
 * 			  각각의 '값들'의 선언된 변수와 자료형이 같아야한다.
...
public class EnumTest {
	...
	//방법 1로 열거형 선언하기
	public enum Color { RED, GREEN, BLUE }  // ; 안붙임
	...
	public enum Season{
		...
		//변수선언
		private String span;
		private int stratMonth;
		
		//생성자
		Season(String span, int stratMonth){
			//private Season(String span, int startMonth) 와 같다.
			this.span = span;
			this.stratMonth = stratMonth;
		}
...
//		}
		...
		System.out.println("stratMonth : " + ss.getstratMonth());
		System.out.println();
