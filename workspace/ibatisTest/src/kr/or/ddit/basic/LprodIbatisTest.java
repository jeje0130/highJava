	...
	public static void main(String[] args) {
		...
		/*	// 2-1. insert 작업
			...
			*/
			...
			// 응답 결과가 여러개일 경우에는 quertForList()메서드를 사용하는데
			...
			*/
			...
			String lprodGu = scan.next();
			lprodGu = (lprodGu + "   ").substring(0, 4).toUpperCase();
			
			// select한 결과가 1개의 레코드일 경우에는 quertForObject()메서드를 사용한다.
			// 형식) smc. quertForObject("namespace값.id속성값", 파라미터클래스);
