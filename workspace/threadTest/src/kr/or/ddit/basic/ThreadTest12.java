...
/*
 * 문제) 10마리의 말들이 경주하는 경마프로그램을 작성하시오
 * 
 * 말은 Horse라는 이름의 쓰레드 클래스로 작성하는데,
 * 이 클래스는 말이름(String), 등수(int), 현재위치값(int)을 멤버 변수로 갖는다.
...
class Horse extends Thread implements Comparable<Horse>{
	...
	public String toString() {
		return "경주마 : " + horseName + "은  "  + rank + "등입니다";
	}
