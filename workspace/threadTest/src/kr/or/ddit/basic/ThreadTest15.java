...
public class ThreadTest15 {
	...
	public static void main(String[] args) {
		...
		// 각각의 쓰레드 객체를 생성하고, 공통으로 사용할 객체를 쓰레드 객체에 주입한다.
...
class ShareData{
	...
	//	즉, CPU의 코어에 있는 캐시를 사용하지 않고 직접 메모리의 데이터를 입출력한다.
	...
	public boolean isChk() {      //논리형일때 get대신 is가 붙는다
		return chk;
	}
