	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		if(sessionValue==null) {
			out.println("<h3>testSession의 세션값이 없습니다");
		}else {
		...
		out.println("세션 가장 최근 접근 시간 : " + session.getLastAccessedTime() + "<br>");
		...
		out.println("<a href='"
				+ request.getContextPath() + "/basic/03/sessionTest.jsp'>시작 문서로 이동하기</a>");
