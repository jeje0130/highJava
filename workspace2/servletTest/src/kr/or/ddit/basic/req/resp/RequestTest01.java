...
public class RequestTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//getParameter ("파라미터명"); ==> 해당 파라미터에 설정된 값을 가져온다.
		...
		//  ==> 가져온 값의 자료형은 'String[ ]' 이다
		
		// getParameterValues()를 이요해서 hobby로 설정된 checkbox의 값을 모두 읽어오기
...
//		}
		...
		//		이 Map객체의 key값은 '파라미터명'이며 자료형은 'String'이고, value값은 해당 파라미터에 저장된 '값'이며
		//		자료형은 'String[]'이다.
